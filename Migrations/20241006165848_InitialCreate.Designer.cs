...
namespace DZ_ChatApp_vSem5.Migrations
{
    ...
    [Migration("20241006165848_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DZ_ChatApp_vSem5.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DZ_ChatApp_vSem5.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DZ_ChatApp_vSem5.Models.Message", b =>
                {
                    b.HasOne("DZ_ChatApp_vSem5.Models.User", "FromUser")
                        .WithMany("MessagesFromUser")
                        .HasForeignKey("FromUserId")
                        .HasConstraintName("message_FromUserId_fkey");

                    b.HasOne("DZ_ChatApp_vSem5.Models.User", "ToUser")
